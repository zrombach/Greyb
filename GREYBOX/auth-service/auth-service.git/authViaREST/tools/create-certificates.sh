...
#
#  This script is provided as a utility to help users 
...
function createServerCertificate
{
	...
	echo ""
	# generate server key
	keytool -genkey -alias ${l_hostname} -keyalg RSA -keypass ${DEFAULT_KEYSTORE_PASSWORD} -keystore ${l_hostkeystorename}  -storepass ${DEFAULT_KEYSTORE_PASSWORD} -dname "CN=${l_hostname}, OU=D00X, O=${l_hostname}, L=${l_hostname}, S=${l_hostname}, C=${DEFAULT_COUNTRY_CODE}"	
...
echo -e "Welcome to the Lab24 Self-Signed Certificate Creation Script. \n"
...
echo -e "This script is provided as a utility to help Lab24 users"
